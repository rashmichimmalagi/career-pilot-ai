...
import { Compass, Sparkles, ShieldAlert, Key, Loader2, ArrowLeft, CheckCircle2, AlertCircle } from 'lucide-react';
        ...
        {!isConfigured && (
          <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-800 dark:text-amber-200 text-xs space-y-2">
            ...
            <p className="text-amber-800/80 dark:text-amber-200/80 leading-relaxed text-[11px]">
              Real Google OAuth requires setting <code className="bg-amber-100 dark:bg-amber-950 border border-amber-300 dark:border-amber-500/30 px-1 py-0.5 rounded text-amber-900 dark:text-amber-300">VITE_SUPABASE_ANON_KEY</code>.
            </p>
            <button
