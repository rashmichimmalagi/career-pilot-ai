    ...
    <div role="region" aria-label="Configuration setup alert" className="bg-amber-500/10 border-b border-amber-500/20 text-amber-200 px-4 py-3">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs sm:text-sm">
        <div className="flex items-center gap-2.5">
          ...
          <span>
            <strong className="font-semibold text-amber-300">Supabase Auth Setup Required:</strong> To enable Google OAuth and Database operations, configure <code className="bg-amber-950/60 text-amber-200 px-1.5 py-0.5 rounded border border-amber-500/30 font-mono text-xs">VITE_SUPABASE_ANON_KEY</code>.
          </span>
        </div>
